...
def _get_db_conninfo():
    ...
    return make_conninfo(
        host=app.env_config.DB_HOST,
        port=app.env_config.DB_PORT,
        dbname=app.env_config.DB_NAME,
        user=app.env_config.DB_USER,
        password=app.env_config.DB_PASSWORD,
    )
